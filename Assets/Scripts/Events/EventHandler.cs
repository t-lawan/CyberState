...
public static class EventHandler
{
    ...
    bool idleUp, bool idleDown, bool idleLeft, bool idleRight)
    {
        ...
        {
            MovementEvent(xInput, yInput, isWalking, isRunning, isIdle, isCarrying, toolEffect, isUsingToolRight, isUsingToolLeft, isUsingToolUp, isUsingToolDown,
    ...
    public static event Action<int, Season, int, string, int, int, int> AdvanceGameSecondEvent;

    public static void CallAdvanceGameSecondEvent(int gameYear, Season gameSeason, int gameDay, string gameDayOfWeek, int gameHour, int gameMinute, int gameSecond)
    {
        if (AdvanceGameSecondEvent != null)
        {
            AdvanceGameSecondEvent(gameYear, gameSeason, gameDay, gameDayOfWeek, gameHour, gameMinute, gameSecond);
        }
    }
