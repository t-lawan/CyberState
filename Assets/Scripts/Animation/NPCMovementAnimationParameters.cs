...
public class NPCMovementAnimationParameters : MonoBehaviour
{
    ...
    public void SetAnimationParameters(float xInput, float yInput, bool isWalking, bool isRunning, bool isIdle, bool isCarrying,
